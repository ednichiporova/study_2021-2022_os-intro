...
![Измененный скрипт №1](image/5.png){ #fig:005 width=70% }
...
![проверка работы скрипта №2](image/11.png){ #fig:0011 width=70% }

![проверка работы скрипта №2](image/12.png){ #fig:0012 width=70% }

![проверка работы скрипта №2](image/13.png){ #fig:0013 width=70% }
